...
class TabFare : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        infoTime = view.findViewById(R.id.info_time3)
        infoDist = view.findViewById(R.id.info_dist3)
        infoFare = view.findViewById(R.id.info_fare3)
        infoTrans = view.findViewById(R.id.info_trans3)
        infoRoute = view.findViewById(R.id.info_route3)
